...
//    public boolean mIsAlreadyTryDecrypt;
//    public boolean mIsLoadStorageAfterSync;
//    public boolean mIsPINNeedEnter;
...
//        inst.mCrypter = new TetroidCrypter(logger, inst.mXml.getLoadHelper(), Instance);
//        boolean res;
//        try {
...
//    }
   ...
   /* public static void startInitStorage(Activity activity, IStorageInitCallback storageInitCallback,
        ...
        if (!PermissionManager.checkWriteExtStoragePermission(activity, Constants.REQUEST_CODE_PERMISSION_WRITE_STORAGE)) {
            return;
        }
...
//        if (SettingsManager.isSyncStorageDef(activity) && SettingsManager.isSyncBeforeInitDef(activity)) {
//            // спрашиваем о необходимости запуска синхронизации, если установлена опция
//            if (SettingsManager.isAskBeforeSyncOnInitDef(activity)) {
...
//            isFavorMode = !isLoaded() && SettingsManager.isLoadFavoritesOnlyDef(context)
...
//                || SettingsManager.isSaveMiddlePassHashLocalDef(context)
...
//                );
//            }
//        // TODO: заменить на SettingsManager.isAskPassOnStart()
...
//                        SettingsManager.isLoadFavoritesOnlyDef(context), false);
//            } else {
...
//     *
//     * TODO: будет вызываться только из StoragesActivity и StorageSettingsActivity
//     *
//     */
...
//        }
//        activity.startActivityForResult(intent, (isNew) ? Constants.REQUEST_CODE_CREATE_STORAGE : Constants.REQUEST_CODE_OPEN_STORAGE);
//    }
...
//        boolean res = SyncManager.startStorageSync(activity, storagePath, Constants.REQUEST_CODE_SYNC_STORAGE);
//        if (callback != null) {
...
//            if (!res || SettingsManager.getSyncAppNameDef(activity).equals(activity.getString(R.string.title_app_termux))) {
//                callback.run();
//            }
//        }
//    }
...
//        if (SettingsManager.isSyncStorageDef(activity) && SettingsManager.isSyncBeforeExitDef(activity)) {
//            if (SettingsManager.isAskBeforeSyncOnExitDef(activity)) {
//                AskDialogs.showSyncRequestDialog(activity, new Dialogs.IApplyCancelDismissResult() {
//                    @Override
//                    public void onApply() {
