...
//     * @param callback
//     */
//    public void createRecordFieldsDialog(Context context, TetroidRecord record,
...
//                ? curRecordNode : (node != null) ? node : nodesInteractor.getQuicklyNode();
//        if (record != null) {
...
//     * @param record
//     */
//    public void createRecordInfoDialog(Context context, TetroidRecord record) {
...
//        if (storageInteractor.isLoadedFavoritesOnly()) {
...
//        }
//        String path = recordsInteractor.getPathToRecordFolder(context, record);
